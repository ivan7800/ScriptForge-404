# V5 Pro - Generador script unidad de red
...
## Descripcion
Genera un BAT independiente para mapear una unidad de red con parametros elegidos.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5 Pro - Generador script unidad de red" con las opciones configuradas por el usuario en ScriptForge 404.

## Motivos del nivel de riesgo
- Plantilla V5 Pro de diagnostico/solo lectura.
