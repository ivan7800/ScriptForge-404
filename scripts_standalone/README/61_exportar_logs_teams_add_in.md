# V5.4 Pro - Exportar logs Teams Add-in
...
## Descripcion
Copia logs de Teams, Add-in y Outlook recientes a carpeta de evidencias.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Exportar logs Teams Add-in" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Exportar logs Teams Add-in
============================================================
