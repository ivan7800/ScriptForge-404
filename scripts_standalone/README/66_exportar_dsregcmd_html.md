# V5.4 Pro - Exportar dsregcmd HTML
...
## Descripcion
Convierte dsregcmd /status a TXT y HTML básico para ticket.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Exportar dsregcmd HTML" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Exportar dsregcmd HTML
============================================================
