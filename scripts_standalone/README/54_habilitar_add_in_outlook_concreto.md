# V5.4 Pro - Habilitar Add-in Outlook concreto
...
## Descripcion
Cambia LoadBehavior=3 para un add-in concreto de Outlook en HKCU/HKLM si existe.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Habilitar Add-in Outlook concreto" con las opciones configuradas por el usuario en ScriptForge 404.
...
Restaurar LoadBehavior anterior desde el CSV/registro exportado.
...
CHECKLIST - V5.4 Pro - Habilitar Add-in Outlook concreto
============================================================
