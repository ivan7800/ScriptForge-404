@echo off
:: ============================================================
:: ScriptForge 404 - V5.4 Pro - Exportar trazas de red para ticket
...
set "LOGFILE=%LOGDIR%\v5_pro_37_exportar_trazas_red_ticket_%date:~-4%%date:~3,2%%date:~0,2%_%time:~0,2%%time:~3,2%.log"
set "LOGFILE=%LOGFILE: =0%"
echo [%date% %time%] Inicio de script: V5.4 Pro - Exportar trazas de red para ticket >> "%LOGFILE%" 2>nul

echo Ejecutando: V5.4 Pro - Exportar trazas de red para ticket
echo.
set "OUT=C:\CAU\ScriptForge404"
if not exist "%OUT%" mkdir "%OUT%" >nul 2>&1
echo V5.4 Pro - Exportar trazas de red para ticket
echo Equipo: %COMPUTERNAME% ^| Usuario: %USERNAME%
echo Salida: %OUT%
echo Preparado para capturar traza de red durante 30 segundos.
