# V5.4 Pro - Backup unidades mapeadas
...
## Descripcion
Exporta unidades de red actuales a CSV y TXT para recuperación posterior.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Backup unidades mapeadas" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Backup unidades mapeadas
============================================================
