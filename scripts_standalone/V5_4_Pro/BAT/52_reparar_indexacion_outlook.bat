@echo off
:: ============================================================
:: ScriptForge 404 - V5.4 Pro - Reparar indexación Outlook
...
set "LOGFILE=%LOGDIR%\v5_pro_52_reparar_indexacion_outlook_%date:~-4%%date:~3,2%%date:~0,2%_%time:~0,2%%time:~3,2%.log"
set "LOGFILE=%LOGFILE: =0%"
echo [%date% %time%] Inicio de script: V5.4 Pro - Reparar indexación Outlook >> "%LOGFILE%" 2>nul

echo Ejecutando: V5.4 Pro - Reparar indexación Outlook
echo.
set "OUT=C:\CAU\ScriptForge404"
if not exist "%OUT%" mkdir "%OUT%" >nul 2>&1
echo V5.4 Pro - Reparar indexación Outlook
echo Equipo: %COMPUTERNAME% ^| Usuario: %USERNAME%
echo Salida: %OUT%
sc query WSearch > "%OUT%\52_wsearch.txt"
