# V5.4 Pro - Diagnóstico Entra ID dsregcmd
...
## Descripcion
Exporta dsregcmd /status y datos de unión AD/AAD.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Diagnóstico Entra ID dsregcmd" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Diagnóstico Entra ID dsregcmd
============================================================
