# V5.4 Pro - Diagnóstico Intune IME
...
## Descripcion
Exporta servicio Intune Management Extension, rutas y eventos.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Diagnóstico Intune IME" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Diagnóstico Intune IME
============================================================
