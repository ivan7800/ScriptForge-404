# V5.4 Pro - Diagnóstico Autopilot ESP
...
## Descripcion
Exporta claves y eventos relacionados con Autopilot/ESP.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Diagnóstico Autopilot ESP" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Diagnóstico Autopilot ESP
============================================================
