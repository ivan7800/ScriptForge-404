# V5 Pro - Exportar logs SCCM Intune

**Categoria:** Logs / Eventos  
...
## Descripcion
Copia logs SCCM/Intune principales a carpeta de salida para escalado.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5 Pro - Exportar logs SCCM Intune" con las opciones configuradas por el usuario en ScriptForge 404.
