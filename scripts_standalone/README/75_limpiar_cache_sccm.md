...
## Descripcion
Vacía caché SCCM mediante UIResource.UIResourceMgr si se activa.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Limpiar caché SCCM" con las opciones configuradas por el usuario en ScriptForge 404.
...
Reiniciar SCCM/Software Center o volver a descargar contenido desplegado si se limpió caché.
...
CHECKLIST - V5.4 Pro - Limpiar caché SCCM
============================================================
