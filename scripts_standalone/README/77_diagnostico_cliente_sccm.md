# V5.4 Pro - Diagnóstico cliente SCCM
...
## Descripcion
Exporta cliente SCCM, site code, servicio, WMI y Software Center.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Diagnóstico cliente SCCM" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Diagnóstico cliente SCCM
============================================================
