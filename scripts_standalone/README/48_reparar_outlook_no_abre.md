# V5.4 Pro - Reparar Outlook no abre
...
## Descripcion
Cierra Outlook opcionalmente y genera accesos de reparación: safe mode, resetnavpane y profiles.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Reparar Outlook no abre" con las opciones configuradas por el usuario en ScriptForge 404.
...
Reabrir Outlook normal. Si se cambió perfil, restaurar perfil anterior desde Panel de correo.
...
CHECKLIST - V5.4 Pro - Reparar Outlook no abre
============================================================
