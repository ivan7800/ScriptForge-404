@echo off
:: ============================================================
:: ScriptForge 404 - V5.4 Pro - Forzar actualización Office C2R
...
set "LOGFILE=%LOGDIR%\v5_pro_56_forzar_actualizacion_office_c2r_%date:~-4%%date:~3,2%%date:~0,2%_%time:~0,2%%time:~3,2%.log"
set "LOGFILE=%LOGFILE: =0%"
echo [%date% %time%] Inicio de script: V5.4 Pro - Forzar actualización Office C2R >> "%LOGFILE%" 2>nul

echo Ejecutando: V5.4 Pro - Forzar actualización Office C2R
echo.
set "OUT=C:\CAU\ScriptForge404"
if not exist "%OUT%" mkdir "%OUT%" >nul 2>&1
echo V5.4 Pro - Forzar actualización Office C2R
echo Equipo: %COMPUTERNAME% ^| Usuario: %USERNAME%
echo Salida: %OUT%
dir "%ProgramFiles%\Common Files\Microsoft Shared\ClickToRun\OfficeC2RClient.exe" > "%OUT%\56_c2r_path.txt" 2>&1
