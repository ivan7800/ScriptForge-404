# V5.4 Pro - Ver Add-ins Outlook LoadBehavior
...
## Descripcion
Exporta todos los add-ins de Outlook y su LoadBehavior para detectar complementos deshabilitados.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Ver Add-ins Outlook LoadBehavior" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Ver Add-ins Outlook LoadBehavior
============================================================
