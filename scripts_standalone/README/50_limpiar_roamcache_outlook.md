# V5.4 Pro - Limpiar RoamCache Outlook
...
## Descripcion
Limpia RoamCache de Outlook tras backup opcional para resolver autocompletado/vistas/cache corrupta.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Limpiar RoamCache Outlook" con las opciones configuradas por el usuario en ScriptForge 404.
...
Restaurar la carpeta RoamCache_Backup si fuera necesario.
...
CHECKLIST - V5.4 Pro - Limpiar RoamCache Outlook
============================================================
