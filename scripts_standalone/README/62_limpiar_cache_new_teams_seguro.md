# V5.4 Pro - Limpiar caché New Teams seguro
...
## Descripcion
Limpia cachés de New Teams con backup opcional y cierre controlado.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Limpiar caché New Teams seguro" con las opciones configuradas por el usuario en ScriptForge 404.
...
Restaurar carpeta MSTeams_backup antes de abrir Teams si fuera necesario.
...
CHECKLIST - V5.4 Pro - Limpiar caché New Teams seguro
============================================================
