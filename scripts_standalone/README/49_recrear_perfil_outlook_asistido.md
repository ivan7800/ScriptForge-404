# V5.4 Pro - Recrear perfil Outlook asistido
...
## Descripcion
Abre panel de perfiles y documenta perfiles actuales. No borra perfiles automáticamente.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Recrear perfil Outlook asistido" con las opciones configuradas por el usuario en ScriptForge 404.
...
Seleccionar de nuevo el perfil anterior desde Panel de correo si el nuevo perfil no funciona.
...
CHECKLIST - V5.4 Pro - Recrear perfil Outlook asistido
============================================================
