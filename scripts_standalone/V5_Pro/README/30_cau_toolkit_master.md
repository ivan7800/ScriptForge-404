...
## Descripcion
Launcher maestro con menu para diagnostico, red, Outlook, Teams, impresoras, Intune/SCCM y logs.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5 Pro - CAU Toolkit Master" con las opciones configuradas por el usuario en ScriptForge 404.
