# V5.4 Pro - Mapear unidades por departamento
...
## Descripcion
Genera mapeos según departamento seleccionado usando una tabla editable dentro del script.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Mapear unidades por departamento" con las opciones configuradas por el usuario en ScriptForge 404.
...
Eliminar las letras mapeadas para el departamento con net use LETRA: /delete.
...
CHECKLIST - V5.4 Pro - Mapear unidades por departamento
============================================================
