# V5.4 Pro - Ver rutas Teams Add-in
...
## Descripcion
Localiza versiones del Teams Meeting Add-in y DLLs disponibles bajo AppData/Program Files.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Ver rutas Teams Add-in" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Ver rutas Teams Add-in
============================================================
