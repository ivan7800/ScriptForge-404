# V5.4 Pro - Exportar drivers impresora
...
## Descripcion
Exporta drivers de impresora instalados con pnputil para backup/evidencia.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Exportar drivers impresora" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Exportar drivers impresora
============================================================
