...
## Descripcion
Comprueba resolución DNS interna/externa usando DNS configurado o servidor DNS concreto.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Test DNS corporativo" con las opciones configuradas por el usuario en ScriptForge 404.
...
CHECKLIST - V5.4 Pro - Test DNS corporativo
============================================================
