# V5.4 Pro - Restaurar unidades mapeadas
...
## Descripcion
Restaura unidades desde CSV generado por el backup de unidades.

## Que hace este script
Genera comandos BAT y PS1 basados en la plantilla "V5.4 Pro - Restaurar unidades mapeadas" con las opciones configuradas por el usuario en ScriptForge 404.
...
Desconectar las unidades restauradas con net use LETRA: /delete.
...
CHECKLIST - V5.4 Pro - Restaurar unidades mapeadas
============================================================
